...
export const STATSIG_LAST_SYNC_USER = 'STATSIG_LOCAL_STORAGE_LAST_SYNC_USER';
export const STATSIG_LAST_SYNC_TIME = 'STATSIG_LOCAL_STORAGE_LAST_SYNC_TIME';
...
export const LOCAL_STORAGE_KEYS: Record<string, boolean> = {
  ...
  STATSIG_LAST_SYNC_USER: true,
  STATSIG_LAST_SYNC_TIME: true
};
